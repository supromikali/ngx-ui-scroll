(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var generateMockAdapter = function () { return ((/** @type {?} */ ({
        ...
        cyclePending: false,
        cyclePending$: new rxjs.BehaviorSubject(false),
        loopPending: false,
        loopPending$: new rxjs.BehaviorSubject(false),
        firstVisible: itemAdapterEmpty,
        firstVisible$: new rxjs.BehaviorSubject(itemAdapterEmpty),
        lastVisible: itemAdapterEmpty,
        lastVisible$: new rxjs.BehaviorSubject(itemAdapterEmpty),
        itemsCount: 0,
    ...
    var State = /** @class */ (function () {
        function State(settings, logger) {
            ...
            this.loopPendingSource = new rxjs.BehaviorSubject(false);
            this.workflowPendingSource = new rxjs.BehaviorSubject(false);
            this.isLoadingSource = new rxjs.BehaviorSubject(false);
            this.firstVisibleSource = new rxjs.BehaviorSubject(itemAdapterEmpty);
            this.lastVisibleSource = new rxjs.BehaviorSubject(itemAdapterEmpty);
